...
function UserForm(props) {
    ...
    const input1Class = "border-gray-200 w-80 border-2 hover:border-yellow-500 focus:outline-none focus:border-yellow-200 rounded-full h-10 pl-4 text-black-500"
    ...
    const errorInput1Class = "border-red-600 w-80 border-2 hover:border-yellow-500 focus:outline-none focus:border-yellow-200 rounded-full h-10 pl-4 text-black-500"
                ...
                >
                    ...
                    {formik => (
                        ...
                        >
                            ...
                            <legend className="text-2xl mb-5 border-yellow-500 border-l-4 pl-2 mt-16">Basic Information</legend>
                            <div className="text-xl w-full ml-3 mt-5">
                            ...
                            <button className="bg-yellow-500 text-gray-900 hover:bg-gray-500 hover:text-gray-200 px-4 py-2 rounded-3xl font-bold transition duration-150 ease-in-out transform hover:scale-110 hover:-translate-y-1 w-40 mt-10" type="submit">
                                Submit
                            </button>
                            </div>
                        </form>
